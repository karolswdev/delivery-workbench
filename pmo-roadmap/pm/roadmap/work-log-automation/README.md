...
**Current phase:** n/a.
**Status:** active — framework shipped, teachable, remotely verifiable, installable without cloning, and agent-native over MCP (phases 0-10, v1.7.0).
...
No phase is open. Phase 10 (Agent Interface) shipped: `dw-mcp`, a
