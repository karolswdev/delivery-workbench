...
**Last updated:** 2026-07-26 (WLA-29-04 done: dispatched agents receive the repository — verified locations, snippets, tests, and lessons in a bounded, hash-bound packet).
**Current phase:** [Phase 29 - Serving ourselves](./phase-29-serving-ourselves/) (open, 5/8).
