...
- **Story:** WLA-16-02 - Receipts-first evidence pairing + retired rows + file-derived stories
- **Status:** done
- **Date:** 2026-07-07

## Proof

### Captured run — 2026-07-08T01:15:00Z

- **Command:** `python3 pmo-roadmap/tests/dw-core-tests.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 31ea095a71549113119d1341f75664ff96396922

```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest.test_codex_flag_opt_out_respected) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.daitmmzt/config.toml; respecting the opt-out
ok
...
----------------------------------------------------------------------
Ran 179 tests in 9.608s

OK
dw hook: claude — 4 installed, 0 already present in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.cxm05_ao/settings.json
dw hook: claude — 0 installed, 4 already present in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.cxm05_ao/settings.json
dw hook: claude — 4 installed, 0 already present in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.x06nvrn4/settings.json
dw hook: clau
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-08T01:15:10Z
...
```text
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.GjyIkP/repo
dw-workbench: http://127.0.0.1:19983/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
...
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.GjyIkP/installed
dw-workbench: http://127.0.0.1:19984/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes happen only via /api/mutations preview→apply inside pm/roadmap; never commits
