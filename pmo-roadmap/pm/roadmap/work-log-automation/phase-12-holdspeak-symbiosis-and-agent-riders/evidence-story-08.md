...
- **Story:** WLA-12-08 - Fix evidence-capture stdin inheritance under dw-mcp
- **Status:** done
- **Date:** 2026-07-03

## Proof

### Captured run — 2026-07-04T03:38:07Z

- **Command:** `cat`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 37705b8dc7a79ebb92dbf27e3be76ac9e4d99bf6
...
- **Command:** `python3 /private/tmp/claude-501/-Users-karol-dev-code-delivery-workbench/fdc6877b-9071-406e-94f9-c2020d111439/scratchpad/mcp-stdin-proof.py`
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** 37705b8dc7a79ebb92dbf27e3be76ac9e4d99bf6
...
Traceback (most recent call last):
  File "/private/tmp/claude-501/-Users-karol-dev-code-delivery-workbench/fdc6877b-9071-406e-94f9-c2020d111439/scratchpad/mcp-stdin-proof.py", line 64, in <module>
...
### Captured run — 2026-07-04T03:38:29Z
...
```text
capture of ['cat'] over a held-open stdin pipe returned in 0.06s
server response: pmo-roadmap/pm/roadmap/work-log-automation/phase-12-holdspeak-symbiosis-and-agent-riders/evidence-story-08.md	0	2026-07-04T03:38:29Z
PASS: stdin-reading child no longer wedges dw-mcp
```

### Captured run — 2026-07-04T03:38:41Z
