...
- **Story:** WLA-32-01 - One calm design language
- **Status:** done
- **Date:** 2026-07-29

## Proof

### Captured run — 2026-07-29T15:28:28Z

- **Command:** `/usr/bin/python3 pmo-roadmap/tests/dw-core-tests.py`
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** e0edbcd7c29b1ed1687436166a9f4a0a118bb3fd

```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.77bonyri/config.toml; respecting the opt-out
ok
...
### Captured run — 2026-07-29T15:49:58Z
...
```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.qtw3j_na/config.toml; respecting the opt-out
ok
test_emit_never_raises_on_garbage (__main__.AgentHooksTest) ... ok
test_emit_quiet_guard_and_unknown_event (__main__.AgentHooksTest) ... ok
test_emit_whitelists_and_never_leaks_content (__main__.AgentHooksTest) ... ok
...
### Captured run — 2026-07-29T16:00:04Z
...
```text
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.41h3iU/repo
dw-workbench: http://127.0.0.1:19019/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
...
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.41h3iU/installed
dw-workbench: http://127.0.0.1:19020/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
...
### Captured run — 2026-07-29T16:00:24Z

- **Command:** `env DW_UI_CAPTURE_DIR=pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/assets DW_UI_CAPTURE_PATTERN=overview-* bash pmo-roadmap/tests/workbench-ui-smoke.sh`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** e0edbcd7c29b1ed1687436166a9f4a0a118bb3fd

```text
workbench-accessibility.py: ok (10 journeys, 22 wide/narrow audits, 85 assertions, suite=core)
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.FPFpUF/repo
dw-workbench: http://127.0.0.1:21370/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
workbench-accessibility.py: ok (3 journeys, 6 wide/narrow audits, 22 assertions, suite=program)
workbench-ui-smoke.sh: ok (192 viewport renders: every view at two widths in light and dark, plus 13 keyboard, semantic, focus, and wide/narrow journey exams)
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.FPFpUF/dw-program-test.jc11e3jt/repo
dw-workbench: http://127.0.0.1:23259/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
```
