...
- **Story:** WLA-32-07 - Mission control for live work
- **Status:** done
- **Date:** 2026-07-29

## Proof

### Captured run — 2026-07-30T04:54:23Z

- **Command:** `/usr/bin/python3 pmo-roadmap/tests/dw-core-tests.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 2c331f4df65d1699ff830b7aa957b395c08133d4

```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.j9ypyp_1/config.toml; respecting the opt-out
ok
...
### Captured run — 2026-07-30T05:05:37Z
...
```text
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.HHvxDG/repo
dw-workbench: http://127.0.0.1:19356/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
...
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.HHvxDG/installed
dw-workbench: http://127.0.0.1:19357/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
...
### Captured run — 2026-07-30T05:06:18Z

- **Command:** `env DW_UI_CAPTURE_DIR=pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/assets DW_UI_CAPTURE_PATTERN=live-* bash pmo-roadmap/tests/workbench-ui-smoke.sh`
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** 2c331f4df65d1699ff830b7aa957b395c08133d4

```text
workbench-accessibility.py: FAIL: active bounded run exposed no keyboard action
workbench-ui-smoke.sh: core accessibility journey exam failed
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.h2d0SG/repo
dw-workbench: http://127.0.0.1:22756/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```

### Captured run — 2026-07-30T05:28:37Z
...
workbench-ui-smoke.sh: core accessibility journey exam failed
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.zfm8bZ/repo
dw-workbench: http://127.0.0.1:22790/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```

### Captured run — 2026-07-30T05:47:19Z
...
workbench-ui-smoke.sh: core accessibility journey exam failed
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.TpzTYk/repo
dw-workbench: http://127.0.0.1:21571/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```

### Captured run — 2026-07-30T05:59:02Z
...
```text
workbench-accessibility.py: FAIL: timed out waiting for wide configuration-only apply to complete; last=False
workbench-ui-smoke.sh: core accessibility journey exam failed
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.eu4aX5/repo
dw-workbench: http://127.0.0.1:21979/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```

### Captured run — 2026-07-30T06:10:58Z
...
```text
workbench-accessibility.py: ok (13 journeys, 30 wide/narrow audits, 208 assertions, suite=core)
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.ypMNAG/repo
dw-workbench: http://127.0.0.1:21923/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
workbench-accessibility.py: ok (3 journeys, 6 wide/narrow audits, 35 assertions, suite=program)
workbench-ui-smoke.sh: ok (224 viewport renders: every view at two widths in light and dark, including seven Live mission-control states, plus the project front door and 16 keyboard, semantic, focus, and wide/narrow journey exams)
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.ypMNAG/dw-program-test.ciy8xp_d/repo
dw-workbench: http://127.0.0.1:24435/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```
