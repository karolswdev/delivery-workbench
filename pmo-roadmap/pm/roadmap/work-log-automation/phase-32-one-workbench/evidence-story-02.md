...
- **Story:** WLA-32-02 - A front door in plain words
- **Status:** done
- **Date:** 2026-07-29

## Proof

### Captured run — 2026-07-29T17:02:17Z

- **Command:** `/usr/bin/python3 pmo-roadmap/tests/dw-core-tests.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** adf21cdb35e4dbabd26c56e5fba3af4ed7bb4a2e

```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.ffwxity1/config.toml; respecting the opt-out
ok
...
### Captured run — 2026-07-29T17:12:22Z
...
```text
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.kmE2Z5/repo
dw-workbench: http://127.0.0.1:18809/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
...
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.kmE2Z5/installed
dw-workbench: http://127.0.0.1:18810/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
...
### Captured run — 2026-07-29T17:12:54Z

- **Command:** `env DW_UI_CAPTURE_DIR=pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/assets DW_UI_CAPTURE_PATTERN=project-* bash pmo-roadmap/tests/workbench-ui-smoke.sh`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** adf21cdb35e4dbabd26c56e5fba3af4ed7bb4a2e
...
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.WjHktz/repo
dw-workbench: http://127.0.0.1:21406/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
...
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.WjHktz/dw-program-test.r3kopnha/repo
dw-workbench: http://127.0.0.1:23195/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
```
