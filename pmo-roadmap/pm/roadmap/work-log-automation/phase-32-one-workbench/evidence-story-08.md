...
- **Story:** WLA-32-08 - Prove it reads and looks right
- **Status:** done
- **Date:** 2026-07-30

## Proof

### Captured run — 2026-07-30T08:21:36Z

- **Command:** `/usr/bin/python3 pmo-roadmap/tests/workbench-language-lint.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 12ba66e94d06ee222877e8680dfed076188f0301
...
### Captured run — 2026-07-30T08:21:37Z
...
```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.jwhauw1s/config.toml; respecting the opt-out
ok
...
test_run_start_accepts_notification_fields_and_still_refuses_unknown_properties (__main__.DwCoreTest) ... ok
...
test_representative_preset_com
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-30T08:33:38Z
...
```text
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.6miIzV/repo
dw-workbench: http://127.0.0.1:18504/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
...
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.6miIzV/installed
dw-workbench: http://127.0.0.1:18505/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
...
### Captured run — 2026-07-30T08:34:05Z

- **Command:** `env DW_UI_REQUIRE_FIREFOX=1 DW_UI_CAPTURE_DIR=pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/assets DW_UI_CAPTURE_PATTERN=*empty* bash pmo-roadmap/tests/workbench-ui-smoke.sh`
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** 12ba66e94d06ee222877e8680dfed076188f0301
...
```text
workbench-language-lint.py: ok (18 reserved terms; negative fixture refused: <negative-fixture>/app.js:1: forbidden term 'grant' in ordinary panel text: 'The grant is visible here.')
workbench-accessibility.py: FAIL: timed out waiting for studio ArrowRight tab activation; last=False
workbench-ui-smoke.sh: core accessibility journey exam failed
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.O2xSgw/repo
dw-workbench: http://127.0.0.1:22154/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```

### Captured run — 2026-07-30T08:42:03Z
...
```text
workbench-language-lint.py: ok (18 reserved terms; negative fixture refused: <negative-fixture>/app.js:1: forbidden term 'grant' in ordinary panel text: 'The grant is visible here.')
workbench-accessibility.py: ok (13 journeys, 30 wide/narrow audits, 10 journey-6-13 keyboard/focus exams, 352 assertions, suite=core)
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.dxRJgg/repo
dw-workbench: http://127.0.0.1:21055/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
workbench-accessibility.py: ok (3 journeys, 6 wide/narrow audits, 6 journey-6-13 keyboard/focus exams, 127 assertions, suite=program)
workbench-ui-smoke.sh: ok (firefox-version='Mozilla Firefox 152.0.5'; 304 viewport renders; desktop-light=76 desktop-dark=76 mobile-light=76 mobile-dark=76; board home, ideation, bounded-run consent, program consent, and eight-state Live matrix; 16 journey 6-13 wide/narrow keyboard/focus exams)
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.dxRJgg/dw-program-test.c1gu4mqu/repo
dw-workbench: http://127.0.0.1:24420/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require guarded preview→apply or an exact single-use token; only a browser-confirmed program action may use pre-granted delivery permission, and the browser adds no authority of its own
```

### Captured run — 2026-07-30T08:50:50Z
...
```text
ERROR pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/evidence-story-08.md: evidence exists but matching story is not done
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-29-serving-ourselves/story-04-serve-knowledge-packets-to-agents.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-29-serving-ourselves/story-09-keep-the-hook-path-healthy-under-worktrees.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-01-design-language.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-02-plain-front-door.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-03-board-runs-the-project.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-04-idea-to-phase-plan.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-05-declare-automation-plainly.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-06-consent-you-can-read.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-07-mission-control-live-work.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-08-prove-it-reads-and-looks-right.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
```

### Captured run — 2026-07-30T08:51:37Z
...
```text
ERROR pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench: all stories are done but final-summary.md is missing
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-29-serving-ourselves/story-04-serve-knowledge-packets-to-agents.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-29-serving-ourselves/story-09-keep-the-hook-path-healthy-under-worktrees.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-01-design-language.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
WARNING pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/story-02-plain-front-door.md: grounding unavailable: derived fact symbol-structure-map is stale: stored index tree f646f66395e60e63c70832a2f90c1a9027ca1ca0, current 12ba66e94d06ee222877e8680dfed076188f0301
