...
- **Story:** WLA-32-04 - From rough idea to phase plan
- **Status:** done
- **Date:** 2026-07-29

## Proof

### Captured run — 2026-07-29T20:11:45Z

- **Command:** `/usr/bin/python3 pmo-roadmap/tests/dw-core-tests.py`
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** 9c58ee844539a3eafb9e5c2f2b4b7bec3e7595f0

```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.x7mdt77y/config.toml; respecting the opt-out
ok
...
docs/interop.md is the read-surface contract; a new route, ... FAIL
...
test_missioncontrol_readonly_fitness_guard (__main__.DwCoreTest) ... FAIL
...
test_resource_locks_and_c
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-29T20:32:33Z
...
```text
test_codex_flag_opt_out_respected (__main__.AgentHooksTest) ... dw hook: codex_hooks is explicitly false in /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/dw-hooks-test.nzr39ml1/config.toml; respecting the opt-out
ok
test_emit_never_raises_on_garbage (__main__.AgentHooksTest) ... ok
test_emit_quiet_guard_and_unknown_event (__main__.AgentHooksTest) ... ok
test_emit_whitelists_and_never_leaks_content (__main__.AgentHooksTest) ... ok
...
### Captured run — 2026-07-29T20:42:16Z
...
```text
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.uhDQ9a/repo
dw-workbench: http://127.0.0.1:19075/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
...
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-workbench-test.uhDQ9a/installed
dw-workbench: http://127.0.0.1:19076/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
...
### Captured run — 2026-07-29T20:42:25Z

- **Command:** `env DW_UI_CAPTURE_DIR=pmo-roadmap/pm/roadmap/work-log-automation/phase-32-one-workbench/assets DW_UI_CAPTURE_PATTERN=ideation-* bash pmo-roadmap/tests/workbench-ui-smoke.sh`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9c58ee844539a3eafb9e5c2f2b4b7bec3e7595f0
...
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.I7zZ4l/repo
dw-workbench: http://127.0.0.1:22101/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
...
dw-workbench: shutting down
dw-workbench: serving /private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pmo-ui-smoke.I7zZ4l/dw-program-test.5d3b6cqr/repo
dw-workbench: http://127.0.0.1:24127/ (localhost or your own .ts.net tailnet; Ctrl-C to stop)
dw-workbench: writes require a guarded preview→apply content boundary or an exact step/run/program token; never stages, certifies, or commits
```
