...
function renderAdoptionMarks(model, key, identity = null, options = {}) {
  ...
  out.innerHTML = `<section class="adoption-marks" aria-labelledby="adoption-marks-title">
    ...
    <p>Marks stay in this browser across steps and reloads. They save no project files and grant no permission.</p>
...
function adoptionReviewBody(model, key) {
  ...
  return `<header class="adoption-review-head"><p class="eyebrow">Roadmap changes · review only</p>
      ...
      <div class="adoption-inert"><strong>Nothing is saved yet.</strong> Reviewing cannot save setup, grant permission, start work, certify, or commit.</div>
    </header>
...
function renderPreviewStep() {
  ...
  app.innerHTML = ideationShell("preview", `<section class="ideation-step ideation-preview" aria-labelledby="ideation-preview-title">
    ...
    ${refusal ? `<div class="guard ideation-refusal" role="alert" tabindex="-1"><strong>Nothing changed.</strong> ${esc(plainSetupRefusal(refusal))}</div>` : `<p>These are the exact configuration files this one-use lease can create. No work, run, program, permission, certification, or commit is included.</p>
...
function renderAppliedStep() {
  ...
  app.innerHTML = ideationShell("apply", `<section class="ideation-step ideation-applied" aria-labelledby="ideation-applied-title">
    ...
    <div class="ideation-success"><strong>Configuration only.</strong><span>No story, run, program, permission, certification, or commit was started.</span></div>
